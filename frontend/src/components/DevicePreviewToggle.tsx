...
export function DevicePreviewToggle() {
  ...
  const { activeDeviceId, setDevice, rotateDevice, isLandscape } = useDevicePreviewStore();
    ...
    <>
      ...
      >
        <button
          ...
          className="bg-black/80 backdrop-blur-sm hover:bg-black text-white p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110"
          title="设备预览切换器 (⌘T)"
        >
